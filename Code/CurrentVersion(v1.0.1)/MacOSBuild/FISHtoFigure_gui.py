...
class usrin():
    def __init__(self, master):   
        ...
        self.folder = ttk.Entry(self.frame, width = 35)
        ...
        self.threshold = ttk.Entry(self.frame, width = 10)
        ...
        self.dubposA_chans = ttk.Entry(self.frame, width = 25)
        ...
        self.dubposAthreshold = ttk.Entry(self.frame, width = 10)
        ...
        self.dubposB_chans = ttk.Entry(self.frame, width = 25)
        ...
        self.dubposBthreshold = ttk.Entry(self.frame, width = 10)
        ...
        self.channel_names = ttk.Entry(self.frame, width = 35)
        ...
        self.dataset_names = ttk.Entry(self.frame, width = 35)
