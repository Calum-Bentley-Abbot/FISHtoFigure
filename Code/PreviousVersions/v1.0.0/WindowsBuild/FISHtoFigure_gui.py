...
class usrin():
    def __init__(self, master):   
        ...
        self.threshold = tk.Entry(self.frame, width = 15, borderwidth = 5)
        ...
        self.dubposA_chans = tk.Entry(self.frame, width = 30, borderwidth = 5)
        ...
        self.dubposAthreshold = tk.Entry(self.frame, width = 15, borderwidth = 5)
        ...
        self.dubposB_chans = tk.Entry(self.frame, width = 30, borderwidth = 5)
        ...
        self.dubposBthreshold = tk.Entry(self.frame, width = 15, borderwidth = 5)
        ...
        self.channel_names = tk.Entry(self.frame, width = 50, borderwidth = 5)
        ...
        self.dataset_names = tk.Entry(self.frame, width = 50, borderwidth = 5)
