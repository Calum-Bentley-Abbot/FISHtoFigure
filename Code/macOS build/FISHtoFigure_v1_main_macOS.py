...
def run(input_folder, hist, scatter, thresh, expression, dubposA, dubposAchans, dubposAthresh, dubposB, dubposBchans, dubposBthresh, chan_headers, dataset_labels):
        ...
        with redirect_stdout(f):                                                                    #redirects the console output to newly created file
            ...
            for a in range(len(path_list)):                                                                             #cycles through csv files created above, this constitutes the main loop for the script
                ...
                if Plot_Spot_Map == 1:
                    ...
                    plt.savefig(f"{output_folder}{datasetlabels[a]} Spot Distribution by Channel", bbox_inches = "tight", dpi=500)
                ...
                if Plot_Spot_Histogram == 1:
                    ...
                    plt.savefig(f"{output_folder}{datasetlabels[a]} Spot Count Occurance Histogram", bbox_inches = "tight", dpi=500)
    ...
    if Plot_RNA_expression == 1:
        ...
        plt.savefig(f"{output_folder}/General Transcript Abundance Analytics/Cell-wise Spot Count by Channel", bbox_inches = "tight", dpi=500)
        ...
        plt.xticks(plt.xticks()[0])
        plt.legend()
        plt.savefig(f"{output_folder}/General Transcript Abundance Analytics/Total Spot Count by Channel", bbox_inches = "tight", dpi=500)
        ...
        plt.xticks(plt.xticks()[0])
        plt.legend()
        plt.savefig(f"{output_folder}/General Transcript Abundance Analytics/Positive Cell Count by Channel", bbox_inches = "tight", dpi=500)
        ...
        plt.savefig(f"{output_folder}/General Transcript Abundance Analytics/Positive Cell Count (All Channels)", bbox_inches = "tight", dpi=500)
    ...
    if Plot_dubposA == 1:
        ...
        plt.legend(custom_lines, datasetlabels)
        plt.savefig(f"{output_folder}/[{dubposAchans}] Positive Cells/Cell-wise Spot Count [{dubposAchans}]", bbox_inches = "tight", dpi=500)
        ...
        plt.xticks(plt.xticks()[0])
        plt.legend(custom_lines, datasetlabels)
        plt.savefig(f"{output_folder}/[{dubposAchans}] Positive Cells/Total Spot Count [{dubposAchans}]", bbox_inches = "tight", dpi=500)
    ...
    if Plot_dubposB == 1:
        ...
        plt.legend(custom_lines, datasetlabels)
        plt.savefig(f"{output_folder}/[{dubposBchans}] Positive Cells/Cell-wise Spot Count [{dubposBchans}]", bbox_inches = "tight", dpi=500)
        ...
        plt.xticks(plt.xticks()[0])
        plt.legend()
        plt.savefig(f"{output_folder}/[{dubposBchans}] Positive Cells/Total Spot Count [{dubposBchans}]", bbox_inches = "tight", dpi=500)
