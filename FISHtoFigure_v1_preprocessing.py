...
def run(rawdata_folder):
    ...
    for i in range(len(file_indices)):
        ...
        path_list.append(infolder + substringa + str(file_indices[i]) + substringb)                             #creates a list of files in the z-stack in the correct order ready for analysis using the file numbers list created above
